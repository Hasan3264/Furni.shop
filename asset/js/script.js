...
$(function(){
  ...
  $('.slider').slick({
        ...
        autoplaySpeed: 1000,
      arrows: true,
        nextArrow: '<i id="next" onclick="next()" class="fa-solid fa-solid fa-chevron-up net-arrow"></i>',
        prevArrow: '<i id="prev" onclick="prev()" class="fa-solid fa-solid fa-chevron-down pre-arrow"></i>',
      vertical: true,
